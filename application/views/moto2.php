...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            gp = xmlDoc.getElementsByTagName("category")[1];
    ...
    <body class = "m2">
        <div class = "nav">
            ...
            <ul>            
                <li> <a href = "<?php echo base_url(); ?>Motogp"> MotoGP </a></li>
                <li> <a class = "active" href = "<?php echo base_url(); ?>Moto2"> Moto2 </a></li>
        ...
        <div class = "contain">
                ...
                <input class="button" type="submit" name="submit_moto2" value="Add Rider">
                </form>
        </div>
        <div class = "contain">
                ...
                <input class="button" type="submit" name="submit_moto2" value="Delete Rider">
                </form>
        </div>
        <div class = "contain">
                ...
                Team: <input type="text" name="r_team"><br> 
                Bike: <input type="text" name="r_bike"><br>
                <input class="button" type="submit" name="submit_moto2" value="Update">
                </form>
        </div>
        </div>
    </body>
